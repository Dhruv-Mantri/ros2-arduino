...
#include "motor_comm_interfaces/msg/detail/motor_array__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = motor_comm_interfaces::msg::MotorArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const motor_comm_interfaces::msg::MotorArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<motor_comm_interfaces::msg::MotorArray *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MotorArray__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const motor_comm_interfaces::msg::MotorArray *>(
...
static size_t _MotorArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MotorArray(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MotorArray__callbacks = {
...
static rosidl_message_type_support_t _MotorArray__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MotorArray__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_motor_comm_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<motor_comm_interfaces::msg::MotorArray>()
{
  return &motor_comm_interfaces::msg::typesupport_fastrtps_cpp::_MotorArray__handle;
}
